    ...
    return (
        <div id="save" className='bg-[#c3efef] max-sm:flex-col w-full flex'>
            <TextContent head="Save ideas you like"
                ...
                btnBg='bg-teal-800'
            />
            <div className="w-[50%] max-sm:w-full py-8">
                <div className='h-[38rem] relative'>
                    <div className="absolute top-1 right-2 max-sm:top-80 max-sm:right-6">
                    ...
                    <div className="absolute top-60 max-sm:top-44 max-sm:-right-0 right-20">
                    ...
                    <div className="absolute top-[24rem] max-sm:-top-8 max-sm:right-1 right-16 w-[10rem] h-[12rem] bg-[url('https://images.unsplash.com/photo-1617806265182-7b3f847f0b75?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-center bg-cover bg-no-repeat rounded-[3rem] ">
                    ...
                    <div className=" absolute top-[23rem] max-sm:mt-2 max-sm:left-0 w-[12rem] h-[12rem] left-40 bg-[url('https://images.unsplash.com/photo-1615876234886-fd9a39fda97f?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-center bg-cover bg-no-repeat rounded-[3rem] ">
                        <div className="relative w-full rounded-[3rem] h-full bg-black/60">
                            <div className='absolute top-6 left-4'>
                    ...
                    <div className="absolute max-sm:top-12 max-sm: w-[22rem] h-[20rem] bg-[url('https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-center bg-cover bg-no-repeat rounded-[3rem] ">
